import svgPaths from "./svg-591rxxyzjx";

function Frame2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-center justify-center min-h-px min-w-px relative">
      <div className="content-stretch flex flex-col items-start px-[12px] py-[8px] relative rounded-[4px] shrink-0" data-name="Component 2">
      ...
      <div className="content-stretch flex flex-col items-start px-[12px] py-[8px] relative rounded-[4px] shrink-0" data-name="Component 4">
...
function Component() {
  return (
    <div className="flex-[1_0_0] h-[36px] min-h-px min-w-px relative rounded-[4px]" data-name="Component 9">
...
function Component1() {
  return (
    <div className="flex-[1_0_0] h-[36px] min-h-px min-w-px relative rounded-[4px]" data-name="Component 11">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex items-center justify-center px-[21px] py-[9px] relative size-full">
...
function SpanRvToggleTrack() {
  return (
    <div className="absolute bg-[rgba(0,255,136,0.15)] border border-[#0f8] border-solid inset-0 rounded-[999px] shadow-[0px_0px_12px_0px_rgba(0,255,136,0.15),0px_0px_32px_0px_rgba(0,255,136,0.15)]" data-name="span.rv-toggle__track">
      <div className="absolute bg-[#0f8] left-[21px] rounded-[7px] size-[14px] top-[3px]" data-name="::after" />
    </div>
  );
}

function LabelRvToggle() {
  return (
    <div className="h-[22px] relative shrink-0 w-[40px]" data-name="label.rv-toggle">
      <SpanRvToggleTrack />
    </div>
  );
}

function SpanRvBodySm() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="span.rv-body-sm">
...
function Label() {
  return (
    <div className="content-stretch flex gap-[12px] items-start relative shrink-0" data-name="label">
      <LabelRvToggle />
      <Frame5 />
    </div>
  );
    ...
    <div className="relative shrink-0 w-full" data-name="div#placeholder">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative w-full">
        <div className="flex flex-col font-['Consolas:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#6b8fa8] text-[14px] w-full">
          <p className="leading-[24px]">{`// add operational notes here…`}</p>
        </div>
      </div>
    </div>
  );
...
function TextareaRvTextarea() {
  return (
    <div className="bg-[#111820] flex-[1_0_0] min-h-[120px] min-w-px relative rounded-[4px] w-full" data-name="textarea.rv-textarea">
...
function DivRvField3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start min-h-px min-w-px relative w-full" data-name="div.rv-field">
      <LabelRvLabel3 />
      <TextareaRvTextarea />
    </div>
  );
...
function Frame8() {
  return (
    <div className="content-stretch flex items-start justify-between leading-[normal] relative shrink-0 text-[#0f8] text-[14px] tracking-[3px] uppercase w-full whitespace-nowrap">
      <p className="font-['Space_Mono:Bold',sans-serif] not-italic relative shrink-0">Security profile: Standard</p>
...
function DivDsNote1() {
  return (
    <div className="relative shrink-0 w-full" data-name="div.ds-note">
...
export default function ShareNote() {
  return (
    <div className="bg-[#080c0e] content-stretch flex flex-col items-center px-[240px] relative size-full" data-name="SHARE - NOTE">
      <Frame />
    </div>
  );
}